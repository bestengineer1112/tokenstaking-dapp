        ...
        !(function (t) {
            function n(t) {
                return (
                    ...
                    })(t.positionClass) || (console.warn("An invalid notification position class has been specified."), (t.positionClass = c.positionClass)),
                    t.onclick && "function" != typeof t.onclick && (console.warn("Notification on click must be a function."), (t.onclick = c.onclick)),
                    "number" != typeof t.showDuration && (t.showDuration = c.showDuration),
                    ((0, o.isString)(t.theme) && 0 !== t.theme.length) || (console.warn("Notification theme must be a string with length"), (t.theme = c.theme)),
                    t
                );
            }
            function e(t) {
            ...
            var c = { closeOnClick: !0, displayCloseButton: !0, positionClass: "nfc-top-right", onclick: !1, showDuration: 3500, theme: "success" };
